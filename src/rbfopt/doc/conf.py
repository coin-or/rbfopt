...
MOCK_MODULES = ['argparse', 'numpy', 'scipy', 'pyDOE', 'scipy.spatial', 
                'scipy.linalg', 'scipy.special', 'pyomo.opt', 'pyomo.environ']
...
project = u'RBFOpt'
copyright = u'2017, Singapore University of Technology and Design and IBM Corporation'
